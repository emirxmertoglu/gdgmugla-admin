              ...
              <v-row justify="center" align="start">
                ...
                <v-col md="8" lg="9" cols="12" sm="8">
                  ...
                  <v-row>
                    ...
                    <v-col md="4" xs="4" lg="4" cols="12" class="ma-0">
                      <v-text-field
                        v-model="updatedeventData.links.kommunity"
                        class="ma-0"
                        label="Event Kommunity URL"
                        outlined
                      ></v-text-field>
                    </v-col>
                  </v-row>
    ...
    return {
      ...
      updatedeventData: {
        ...
        links: {
          ...
          kommunity: this.eventInfo.links.kommunity,
        },
        time: {
    ...
    SaveEvent() {
      ...
      let datatoupdate = {
        ...
        links: {
          ...
          kommunity: this.updatedeventData.links.kommunity,
        },
        time: {
